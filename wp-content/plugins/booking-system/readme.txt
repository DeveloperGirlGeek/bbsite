=== Pinpoint Booking System - Book everything with WordPress or WooCommerce ===
Contributors: DOTonPAPER
Donate link: https://pinpoint.world/wordpress/
...
<blockquote>
    <p>
	<a href="https://pinpoint.world/wordpress/">The website</a> | <a href="https://pinpoint.world/wordpress/examples/">Demos</a> | <a href="https://pinpoint.world/wordpress/shop/">WooCommerce demo</a>
	<br />
	<a href="https://wordpress.org/support/plugin/booking-system/">Support for FREE version</a> | <a href="https://pinpoint.world/wordpress/support/">Support for PRO version</a> | <a href="https://wordpress.org/support/view/plugin-reviews/booking-system?filter=5">Reviews</a>
	<br />
	<a href="https://pinpoint.world/wordpress/features/">Features</a> | <a href="https://pinpoint.world/wordpress/documentation/">Documentation</a>
	<br />
	<a href="https://pinpoint.world/">PINPOINT.WORLD</a> | <a href="https://pinpoint.world/shop/product/1/pinpoint-booking-system-wordpress-plugin-pro-version">PRO version</a> | <a href="https://pinpoint.world/wordpress/addons/">Add-ons</a>
    </p>
</blockquote>
...
The administration area is intuitive, powerful, flexible and very easy to manage availability and reservations, making Pinpoint Booking System equally good for big or small businesses and individuals. The functionalities of Pinpoint Booking System can be enhanced using [add-ons](https://pinpoint.world/wordpress/addons/).

<br />

<h3>Extend with WooCommerce</h3>
<br />
A key feature of Pinpoint Booking System is WooCommerce integration. Creating WooCommerce bookings is very easy, and the most important thing us that you can take advantage of the shopping cart, all payment methods and other features that come with WooCommerce & all the plugins created for the most popular WordPress eCommerce toolkit.

<br />

<h3>Share with <a href="https://pinpoint.world/">PINPOINT.WORLD</a></h3>
<br />
A unique feature of the plugin is the ability to share your business location on [PINPOINT.WORLD](https://pinpoint.world/), which will make you known to the world and you will attract more customers.
...
**View complete [List of Features](https://pinpoint.world/wordpress/features/)**
...
View [demo](https://pinpoint.world/wordpress/) here.
...
= 2.1.9 =
* "Add-ons" activation has been improved. You can delete an activation from [Dot on Paper Shop](https://pinpoint.world/user/licences/) if you have deleted the add-on and you have not deactivated it or if you want to activate it on another domain. Also the notification disappears after what the update is completed.
